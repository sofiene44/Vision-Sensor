...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.validation1 = QtGui.QLabel(self.background)
        self.validation1.setBaseSize(QtCore.QSize(0, 0))
        self.validation1.setStyleSheet(_fromUtf8("color: rgb(0, 0, 0);"))
        self.validation1.setText(_fromUtf8(""))
        self.validation1.setTextFormat(QtCore.Qt.PlainText)
        self.validation1.setScaledContents(False)
        self.validation1.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.validation1.setObjectName(_fromUtf8("validation1"))
        self.horizontalLayout_10.addWidget(self.validation1)
        ...
        self.validation2 = QtGui.QLabel(self.background)
        self.validation2.setBaseSize(QtCore.QSize(0, 0))
        self.validation2.setStyleSheet(_fromUtf8("color: rgb(0, 0, 0);"))
        self.validation2.setText(_fromUtf8(""))
        self.validation2.setTextFormat(QtCore.Qt.PlainText)
        self.validation2.setScaledContents(False)
        self.validation2.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.validation2.setObjectName(_fromUtf8("validation2"))
        self.horizontalLayout_12.addWidget(self.validation2)
        ...
        self.validation3 = QtGui.QLabel(self.background)
        self.validation3.setBaseSize(QtCore.QSize(0, 0))
        self.validation3.setStyleSheet(_fromUtf8("color: rgb(0, 0, 0);"))
        self.validation3.setText(_fromUtf8(""))
        self.validation3.setTextFormat(QtCore.Qt.PlainText)
        self.validation3.setScaledContents(False)
        self.validation3.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.validation3.setObjectName(_fromUtf8("validation3"))
        self.horizontalLayout_11.addWidget(self.validation3)
        ...
        self.validation4 = QtGui.QLabel(self.background)
        self.validation4.setBaseSize(QtCore.QSize(0, 0))
        self.validation4.setStyleSheet(_fromUtf8("color: rgb(0, 0, 0);"))
        self.validation4.setText(_fromUtf8(""))
        self.validation4.setTextFormat(QtCore.Qt.PlainText)
        self.validation4.setScaledContents(False)
        self.validation4.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.validation4.setObjectName(_fromUtf8("validation4"))
        self.horizontalLayout_13.addWidget(self.validation4)
