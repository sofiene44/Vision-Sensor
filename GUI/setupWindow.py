...
class Ui_SetupWindow(object):
    def setupUi(self, SetupWindow):
        ...
        self.NextStepButton_2 = QtGui.QPushButton(self.centralwidget)
        self.NextStepButton_2.setMinimumSize(QtCore.QSize(100, 0))
        self.NextStepButton_2.setObjectName(_fromUtf8("NextStepButton_2"))
        self.verticalLayout_4.addWidget(self.NextStepButton_2)
        ...
        QtCore.QObject.connect(self.NextStepButton, QtCore.SIGNAL(_fromUtf8("clicked(bool)")), self.saveMasterImageButton.setEnabled)
        QtCore.QObject.connect(self.NextStepButton, QtCore.SIGNAL(_fromUtf8("clicked(bool)")), self.RetakeImageButton.setEnabled)
        QtCore.QObject.connect(self.NextStepButton, QtCore.SIGNAL(_fromUtf8("clicked(bool)")), self.SnapshotButton.setEnabled)
        QtCore.QObject.connect(self.NextStepButton_2, QtCore.SIGNAL(_fromUtf8("clicked(bool)")), self.saveMasterImageButton.setDisabled)
        QtCore.QObject.connect(self.NextStepButton_2, QtCore.SIGNAL(_fromUtf8("clicked(bool)")), self.RetakeImageButton.setDisabled)
        QtCore.QObject.connect(self.NextStepButton_2, QtCore.SIGNAL(_fromUtf8("clicked(bool)")), self.SnapshotButton.setDisabled)
        QtCore.QObject.connect(self.NextStepButton_2, QtCore.SIGNAL(_fromUtf8("clicked()")), self.ToolsListSetup.hide)
    ...
    def retranslateUi(self, SetupWindow):
        ...
        self.NextStepButton_2.setText(_translate("SetupWindow", "previous step", None))
